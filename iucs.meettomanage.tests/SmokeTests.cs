...
using iucs.meettomanage.application.Dto.Academics;
using iucs.meettomanage.application.Dto.Admission;
using iucs.meettomanage.application.Dto.Auth;
using iucs.meettomanage.application.Dto.Batches;
...
using iucs.meettomanage.application.Dto.Navigation;
...
using iucs.meettomanage.application.Dto.Quizzes;
using iucs.meettomanage.application.Dto.Reports;
...
using iucs.meettomanage.application.Helper;
...
using iucs.meettomanage.domain.Entities.Auditing;
...
using iucs.meettomanage.domain.Entities.Quizzes;
...
namespace iucs.meettomanage.tests
{
    public class SmokeTests : IDisposable
    {
        ...
        public void HtmlText_PlainTextFromHtml_StripsMarkupAndBrandChrome()
        {
            ...
            var plain = iucs.meettomanage.application.Common.HtmlText.PlainTextFromHtml(rendered);
