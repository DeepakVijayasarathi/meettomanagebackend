...
namespace iucs.meettomanage.tests
{
    ...
    /// <summary>
    /// Real MeetToManageDbContext (audit interceptor included) over SQLite in-memory,
    ...
    public sealed class TestDatabase : IDisposable
    {
        ...
        public TestDatabase()
        {
            ...
            var options = new DbContextOptionsBuilder<MeetToManageDbContext>()
                .UseSqlite(_connection)
                .AddInterceptors(new AuditableEntityInterceptor(CurrentUser))
                .Options;

            Context = new MeetToManageDbContext(options);
        ...
        public MeetToManageDbContext Context { get; }
        ...
        /// </summary>
        public (MeetToManageDbContext Context, IUnitOfWork UnitOfWork) CreateConcurrentSession()
        {
            var options = new DbContextOptionsBuilder<MeetToManageDbContext>()
                .UseSqlite(_connection)
                .AddInterceptors(new AuditableEntityInterceptor(CurrentUser))
                .Options;
            var context = new MeetToManageDbContext(options);
