...
using iucs.meettomanage.domain.Entities.Resources;
...
namespace iucs.meettomanage.domain.Data
{
    public class MeetToManageDbContext : DbContext
    {
        public MeetToManageDbContext(DbContextOptions<MeetToManageDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(MeetToManageDbContext).Assembly);
