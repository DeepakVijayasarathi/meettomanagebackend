...
using iucs.meettomanage.application.Common;
...
namespace iucs.meettomanage.api.Data
{
    /// <summary>
    ...
    public static class DatabaseInitializer
    {
        public static async Task InitializeAsync(IServiceProvider services, IConfiguration configuration)
        {
            ...
            var context = scope.ServiceProvider.GetRequiredService<MeetToManageDbContext>();
        ...
        /// </summary>
        private static async Task SeedDepartmentsAsync(MeetToManageDbContext context)
        {
        ...
        private static async Task SeedPaymentAccountsAsync(MeetToManageDbContext context)
        {
        ...
        private static async Task SeedSettingsAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task BackfillSystemRolePermissionsAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task RemoveRetiredMenusAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task BackfillMenuRequiredModulesAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureSubAdminIntegrationsMenuAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsurePackagesAndStudentViewMenusAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureAdminDepartmentsMenuAsync(MeetToManageDbContext context)
        {
        ...
        /// needs to move.
        /// </summary>
        private static async Task EnsureAdminQuizBankMenuAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureAdminServerMonitoringMenuAsync(MeetToManageDbContext context)
        {
        ...
        /// <summary>
        /// Inserts the Admin "Marketing" section (Demo Requests, Blog Posts) into a database
        /// seeded before this section existed. A brand-new section, unlike
        /// EnsureAdminQuizBankMenuAsync/EnsureAdminServerMonitoringMenuAsync appending to an
        /// existing one — computes the next SectionOrder rather than reusing one, so it lands
        /// after every current admin section without disturbing their order.
        /// </summary>
        private static async Task EnsureAdminMarketingMenuAsync(MeetToManageDbContext context)
        {
            const string demoRequestsPath = "/admin/demo-requests";
            const string blogPostsPath = "/admin/blog-posts";
            if (context.MenuItems.Local.Any(m => m.Portal == "admin" && (m.Path == demoRequestsPath || m.Path == blogPostsPath)) ||
                await context.MenuItems.AnyAsync(m => m.Portal == "admin" && (m.Path == demoRequestsPath || m.Path == blogPostsPath)))
            {
                return;
            }

            var adminItems = await context.MenuItems.Where(m => m.Portal == "admin").ToListAsync();
            var nextSectionOrder = adminItems.Count == 0 ? 0 : adminItems.Max(m => m.SectionOrder) + 1;
            ...
            context.MenuItems.AddRange(
                new MenuItem
                {
                    ...
                    Label = "Demo Requests",
                    Path = demoRequestsPath,
                    Icon = "Handshake",
                    SortOrder = 0,
                    IsActive = true,
                    RequiredModule = PermissionModule.Marketing,
                },
                new MenuItem
                {
                    Portal = "admin",
        ...
        /// <summary>
        /// The public blog was originally static frontend content; this seeds those same
        /// three posts into the database so the live site's /blog doesn't go empty the
        /// moment it switches to being DB-backed. Only runs once (empty table).
        /// </summary>
        private static async Task SeedBlogPostsAsync(MeetToManageDbContext context)
        {
            ...
            context.BlogPosts.AddRange(
                ...
                new BlogPost
                {
                    ...
                    Excerpt = "A demo booking is the start of a pipeline, not a one-off event. Here's every step that has to work for it to end in an enrolled family.",
                    ReadMinutes = 4,
                    IsPublished = true,
                    PublishedAtUtc = new DateTime(2026, 7, 28, 0, 0, 0, DateTimeKind.Utc),
                    Content = """
                ...
                new BlogPost
                {
                    ...
                    Excerpt = "Chasing a late fee is uncomfortable for everyone. Here's why automating the suspension — and the restoration — removes the discomfort entirely.",
                    ReadMinutes = 4,
                    IsPublished = true,
                    PublishedAtUtc = new DateTime(2026, 8, 11, 0, 0, 0, DateTimeKind.Utc),
                    Content = """
        ...
        private static async Task SeedMenusAsync(MeetToManageDbContext context)
        {
        ...
        private static async Task SeedIntegrationsAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureCashPaymentMethodAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureSmsIntegrationAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureJitsiAutoRecordConfigAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureEmailTemplatesMenuAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureProgressReportsMenuAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureChatbotMenusAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task SeedChatFaqsAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureAdditionalChatFaqsAsync(MeetToManageDbContext context)
        {
        ...
        /// get it from MenuSeedItems(); this only fires for pre-existing ones.
        /// </summary>
        private static async Task EnsureStoreInquiriesMenuAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureParentRecordingsMenuAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureProgressReportEmailTemplateAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsurePinResetEmailTemplateAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task SeedEmailTemplatesAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task EnsureAccessRequestEmailTemplatesAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task ReconcileJoinLinkEmailTemplatesAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task BackfillPlainTextNotificationBodiesAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task ReconcileWelcomeCredentialsPinTemplateAsync(MeetToManageDbContext context)
        {
        ...
        /// </summary>
        private static async Task ReconcileOrgNameEmailTemplatesAsync(MeetToManageDbContext context)
        {
